...
function STATUSPOINTCHECK_TOGGLE_FRAME()
	...
	--ui.MsgBox_NonNested("データ収集のため少々時間がかかります。{nl}よろしいですか？", nil, "_STATUSPOINTCHECK_TOGGLE_FRAME()", 'None');
    _STATUSPOINTCHECK_TOGGLE_FRAME()
end
function _STATUSPOINTCHECK_TOGGLE_FRAME()
