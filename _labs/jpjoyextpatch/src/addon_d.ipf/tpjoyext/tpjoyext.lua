...
function JOYSTICK_QUICKSLOT_EXECUTE(slotIndex)
	...
	elseif input_L1 == 1 and input_R2 == 1 then
		--CHAT_SYSTEM("ON_L1R2");
		if	slotIndex == 2	or slotIndex == 14 then	-- △
			slotIndex = 15
		elseif	slotIndex == 0	or slotIndex == 12 then
...
function UPDATE_JOYSTICK_INPUT(frame)
	...
	local gboxL1R2 = frame:GetChildRecursively("L1R2_slot_Set1");
	...
	if input_L1 == 1 and input_R2 == 1 and input_L2 == 0 and input_R1 == 0 then
		gboxL1R2:SetSkinName(padslot_onskin);
	else
		gboxL1R2:SetSkinName(padslot_offskin);
	end
	if input_L2 == 1 and input_R1 == 1 and input_L1 == 0 and input_R2 == 0 then
