...
g.classes.JSNNativeExtender = function(interface)
    ...
    local object = g.CombineTable(interface,obj)
    return object
end
g.classes.JSNInterface = function(nativeParentControl)
    local self = {
        _className = "JSNInterface",
        ...
        createorGetNativeControl = function(self, type, prefix)
            ...
            nativeControl = g.classes.JSNNativeExtender(nativeControl):init()
