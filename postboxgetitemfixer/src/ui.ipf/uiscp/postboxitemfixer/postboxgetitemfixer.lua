...
if POSTBOXITEMFIXER_ISHIDELOGIN_OLD == nil and barrack.IsHideLogin ~= AS_ISHIDELOGIN then
    POSTBOXITEMFIXER_ISHIDELOGIN_OLD = barrack.IsHideLogin
    barrack.IsHideLogin = POSTBOXITEMFIXER_ISHIDELOGIN
end

function POSTBOXITEMFIXER_ISHIDELOGIN()
    --ここでフック
