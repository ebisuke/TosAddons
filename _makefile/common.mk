...
IPFPATTERN_WITH_EMOJI_FOR_ADDONMANAGER=_$(NAME)-$(EMOJI)-v*.ipf	
...
uninstall: 
	@echo uninstall
	rm -v $(TREEOFSAVIOR_DATA_DIR)/$(IPFPATTERN_WITH_EMOJI) | true
	rm -v $(TREEOFSAVIOR_DATA_DIR)/$(IPFPATTERN_WITH_EMOJI_FOR_ADDONMANAGER)  | true
