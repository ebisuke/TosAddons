...
* ロックしている装備は対象外です
* イコル解除費用は休憩時のものとなります
* セビノスなど、ランダムオプションが解除できない装備にイコルを付けようとすると失敗します
* 不具合防止のため、倉庫の右下１スロット分は使用しません
## 対応している装備
...
# リリースノート
## v0.6.3
* 度々イコル消失の報告があるのと、ゴッデス導入により需要が減退したのでイコル機能を削除
　 （イコルを意図的に削除するコードは当然含めておりませんため、もしイコルが消失した方は運営までお問い合わせください。）
## v0.6.2
* 一部環境で正常に動作しない問題を修正
## v0.6.1
* 使っていないコードを一部削除
  アップデートして動かなくなった場合はこれで直るはず
## v0.6.0
* 不安定なのでモンスターカード対応機能を削除
* イコル脱着機能追加
## v0.5.0
* モンスターカードに対応
## v0.4.4
