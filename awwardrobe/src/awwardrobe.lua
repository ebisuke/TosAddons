...
function AWWARDROBE_ON_OPEN_ACCOUNT_WAREHOUSE()
    AWWARDROBE_try(function()
        ...
        --initialize
        local btnawwwithdraw = frame:CreateOrGetControl("button", "btnawwwithdraw", 135, 180, 70, 30)
        ...
        local btnawwdeposit = frame:CreateOrGetControl("button", "btnawwdeposit", 215, 180, 70, 30)
        ...
        local btnawwconfig = frame:CreateOrGetControl("button", "btnawwconfig", 295, 180, 70, 30)
        ...
        local cbwardrobe = frame:CreateOrGetControl("droplist", "cbwardrobe", 135, 160, 250, 20)
